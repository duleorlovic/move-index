...
JSONAPI.configure do |config|
  ...
  # Set this to false if your backend does not support transactions (e.g.
  # Mongodb)
  ...
  # On Resources with caching enabled, this field will be used to check for
  # out-of-date cache entries, unless overridden on a specific Resource.
  ...
  # Optionally provide a callable which JSONAPI will call with information about
  # cache performance. Should accept three arguments: resource name, hits count,
  # misses count.
