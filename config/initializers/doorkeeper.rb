Doorkeeper.configure do
  ...
  # (disabled by default) Optional parameter confirmation: true (default false)
  # if you want to enforce ownership of
  ...
  # Change the way access token is authenticated from the request object.  By
  # default it retrieves first from the `HTTP_AUTHORIZATION` header, then falls
  # back to the `:access_token` or `:bearer_token` params from the `params`
  # object.  Check out the wiki for more information on customization
  ...
  # authorization code will be displayed within the provider The value can be
  # any string. Use nil to disable this feature. When disabled, clients must
  # provide a valid URL (Similar behaviour:
