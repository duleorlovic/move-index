...
Devise.setup do |config|
  ...
  config.mailer_sender = 'please-change-initializers-devise@example.com'
  ...
  # on authentication.  The same considerations mentioned for
  ...
  # config.pepper = 'd2206a0ff7e30bdb9623972cec8cf57742e73057b6933f7435f9315cde'
  ...
  # or algorithms from others authentication tools as :clearance_sha1,
  # :authlogic_sha512 (then you should set stretches above to 20 for default
  # behavior) and :restful_authentication_sha1 (then you should set stretches to
