...
RspecApiDocumentation.configure do |config|
  ...
  # You can define documentation groups as well. A group allows you generate
  ...
  config.define_group :public do |public_config|
    ...
    public_config.filter = :public
  end

  # Change how the post body is formatted by default, you can still override by
  # `raw_post`
  ...
  # Change the embedded style for HTML output. This file will not be processed
  # by RspecApiDocumentation and should be plain CSS.
  ...
  # Removes the DSL method `method`, this is required if you have a parameter
  # named method
